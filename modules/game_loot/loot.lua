...
function init()
  ...
  skillsButton = modules.client_topmenu.addRightGameToggleButton('lootButton', tr('Automatics Toggle') .. ' (Ctrl+e)', '/images/topbuttons/loot', requestShow)
  skillsButton:setWidth(32)
  skillsButton:setOn(false)
  
  g_keyboard.bindKeyDown('Ctrl+e', requestShow)
