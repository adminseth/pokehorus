...
--{ name = "aeladon",    pos = {x = 1000, y = 1000, z = 7}, c = "celadon"},--
{ name = "saffron",    pos = {x = 1000, y = 1000, z = 7}, c = "saffron"},
{ name = "celadon",    pos = {x = 794, y = 952, z = 7}, c = "celadon"},
{ name = "fuchsia",    pos = {x = 1058, y = 1313, z = 7}, c = "fuchsia"},
{ name = "lavender",    pos = {x = 1192, y = 1002, z = 7}, c = "lavender"},
{ name = "pewter",    pos = {x = 819, y = 778, z = 7}, c = "pewter"},
{ name = "vermilion",    pos = {x = 982, y = 1179, z = 7}, c = "vermilion"},
{ name = "viridian",    pos = {x = 534, y = 985, z = 7}, c = "viridian"},
{ name = "crystal onix",    pos = {x = 1244, y = 834, z = 7}, c = "crystal onix"},
{ name = "aerodactyl",    pos = {x = 1357, y = 778, z = 7}, c = "aerodactyl"},
...
if set == 0 then
		...
		if not minimapWidget:recursiveGetChildById('mapId') then
			...
			map:setId('mapId')
			map:setOpacity(0.1)
			minimapWidget:centerInPosition(map, {x = 914, y = 966, z = 7})
		end
...
function toggleFullMap(opcode)
  ...
  if not fullmapView and (not opcode or opcode ~= "yes") then
	...
	minimapWidget:getChildById('tptext'):setText("Teleport to house")
