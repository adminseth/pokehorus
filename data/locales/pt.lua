locale = {
  ...
  translation = {
    ...
    ["%s: (use object on pokemon)"] = "%s: (usar objeto no pokemon)",
    ...
    ["Level"] = "Nível",
    ["Lifetime Premium Account"] = "Forever VIP Account.",
    ...
    ["Show skills of the pokemon"] = "Mostrar habilidades do pokemon",
    ...
    ["Use on pokemon"] = "Usar no pokemon",
